package com.android.habhab.model;
...
public class Category implements Saleable, Serializable {
    ...
    public Category(int pId, String pName, BigDecimal pPrice, String pDescription, String pImageName) {
        setId(pId);
        setName(pName);
        setPrice(pPrice);
    ...
    public boolean equals(Object o) {
        ...
        return (this.pId == ((Category) o).getId());
    }
